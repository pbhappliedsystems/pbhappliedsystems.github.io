...
// Demo CTAs arrive as /contact?service=ai-evaluation. An absent or unrecognised
// value is ignored, leaving the select on its disabled placeholder option.
(function prefillService() {
  const requested = new URLSearchParams(window.location.search).get('service');
  if (requested && VALID_SERVICES.includes(requested)) {
    document.getElementById('contactService').value = requested;
  }
})();